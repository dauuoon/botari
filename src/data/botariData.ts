...
export const characterOptions: CharacterOption[] = [
  {
    value: 'tiger',
    label: '호랑이',
    thumbnail: '/assets/characters/tiger.svg',
    promptTemplate: '호랑이의 강인하고 용맹한 분위기를 강조합니다.',
  },
  {
    value: 'haetae',
    label: '해태',
    thumbnail: '/assets/characters/haetae.svg',
    promptTemplate: '해태의 수호적이고 위엄 있는 분위기를 담습니다.',
  },
  {
    value: 'dragon',
    label: '용',
    thumbnail: '/assets/characters/dragon.svg',
    promptTemplate: '용의 역동적이고 신비로운 기운을 표현합니다.',
  },
  {
    value: 'magpie',
    label: '까치',
    thumbnail: '/assets/characters/magpie.svg',
  ...
  },
  {
    value: 'carp',
    label: '잉어',
    thumbnail: '/assets/characters/carp.svg',
    promptTemplate: '잉어의 힘찬 도약과 풍요로운 상징성을 강조합니다.',
  },
  {
    value: 'other',
    label: '기타',
    thumbnail: '/assets/characters/landscape.svg',
...
export const botariStyles: StyleOption[] = [
  {
    ...
    label: '전통 민화',
    tone: 'burnt',
    thumbnail: '/assets/styles/traditional.svg',
  ...
  },
  {
    ...
    label: '수묵 담채화',
    tone: 'ink',
    thumbnail: '/assets/styles/ink.svg',
  ...
  },
  {
    ...
    label: '모던화',
    tone: 'sepia',
    thumbnail: '/assets/styles/modern.svg',
  ...
  },
  {
    ...
    label: '실사화',
    tone: 'gold',
    thumbnail: '/assets/styles/realistic.svg',
  ...
  },
  {
    ...
    label: '스케치',
    tone: 'stone',
    thumbnail: '/assets/styles/sketch.svg',
